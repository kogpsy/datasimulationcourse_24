...
If you are proficient (i.e. regular use) in R and RStudio, you can skip this day as we will provide a general introduction only. The content of the introduction can be found [here](www.kogpsy.github.io/datasimulationcourse_24/introduction.html). The script for day 1 will be also available on this website.
