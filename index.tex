...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, colback=white, opacityback=0, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, left=2mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, colback=white, opacityback=0, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, left=2mm, rightrule=.15mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, colback=white, opacityback=0, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, left=2mm, rightrule=.15mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, colback=white, opacityback=0, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-caution-color-frame, left=2mm, rightrule=.15mm]
\begin{minipage}[t]{5.5mm}
...
Even art can be created with the \texttt{ggplot}-library as shown
\href{https://www.data-imaginist.com/art}{hier}.
...
{\centering \includegraphics{datavisualization_files/figure-pdf/unnamed-chunk-2-1.pdf}
...
\href{https://github.com/rstudio/cheatsheets/blob/main/data-visualization.pdf}{Here}
you can download \texttt{ggplot}-Cheatsheet
...
{\centering \includegraphics{datavisualization_files/figure-pdf/unnamed-chunk-3-1.pdf}
...
{\centering \includegraphics{datavisualization_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
\textbf{\texttt{esquisse}-package}\vspace{2mm}
...
If we do not want to load the whole library we can call the function by
writing the library name then \texttt{::} and the function afterwards
such as \texttt{esquisse::esquisser()}. This is helpful when libraries
have overlapping function names which can create conflicts or to easily
call a function without typing \texttt{library()} first.
