...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, left=2mm, breakable, toprule=.15mm, opacityback=0, colframe=quarto-callout-warning-color-frame, colback=white, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm]
...
The data we used is from Matejka and Fitzmaurice (2017) and can be found
\href{https://dl.acm.org/doi/10.1145/3025453.3025912}{here}
...
\markboth{Ressources}{Ressources}
...
\addcontentsline{toc}{section}{\texttt{.Rmd}-Files we used in the
workshop}

\markright{\texttt{.Rmd}-Files we used in the workshop}
...
\addcontentsline{toc}{section}{Helpful online books and websites}

\markright{Helpful online books and websites}
